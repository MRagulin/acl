...
from .views import AclCreate, AclOver, AclCreate_internal, AclCreate_dmz, AclTest, AclCreate_external, AclCreate_traffic, AclDemo, ACldefault
...
urlpatterns = [
    ...
    path("create/<uuid:acl_id>/", AclCreate.as_view(), name="aclcreate_urls"),
